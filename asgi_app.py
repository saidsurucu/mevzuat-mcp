...
This module provides ASGI/HTTP access to the Mevzuat MCP server,
...
from mevzuat_mcp_server import app as mcp_server
...
app = FastAPI(
    ...
    description="MCP server for Turkish Ministry of Justice's Legislation Information System",
    version="0.1.0",
...
async def health_check():
    ...
    return {
        ...
        "version": "0.1.0",
        "tools_count": len(mcp_server._tool_manager._tools) if hasattr(mcp_server, '_tool_manager') else 2
    }
...
async def root():
    ...
    return {
        ...
        "supported_features": [
            "Turkish legislation search with advanced operators",
...
async def status():
    ...
    return {
        ...
        "data_sources": {
            "mevzuat_api": "Turkish Ministry of Justice Legislation Information System",
